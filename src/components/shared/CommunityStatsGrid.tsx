...
// compartilhado com LiveBanner; Twitch/Kick/TikTok vêm de
// /api/community-stats, cada uma com seu próprio fetch ao vivo, cache só
// como fallback — TikTok via um endpoint interno não-documentado, sem
// OAuth nem infra extra, ver functions/lib/tiktokLive.ts). Discord mostra
