...
export function partnershipEmailHtml({ name, email, phone, message }: PartnershipSubmission): string {
  return `<div style="font-family:Arial,sans-serif;background:#03070b;color:#f3f5f7;padding:32px">
  ...
  <table style="width:100%;border-collapse:collapse;margin:0 0 24px">
    ...
    <tr><td style="color:#9eacb9;padding:4px 0">Celular</td><td>${phone ? escapeHtml(phone) : '—'}</td></tr>
  </table>
